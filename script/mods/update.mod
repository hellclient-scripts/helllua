...
updateversion=function()
	addtri("remote","^(> )*[^~].{1,4}\\((.*)\\)告诉你：do (.+)","system","remote_called")
	...
	addtri("block_onnpc","^(> )*(.*)(拦住你道|上前挡住你，朗声说道：|一把拦住你，喝道：|美目一挑，想走，没门！|喝道：“威……武……|向你喝道：什么人|拦住了你的去路|伸手拦住你说道|喝道：别乱逛|拦住你说：此处乃明教重地|对你道：对不起|喝道：这位|伸手拦住你白眼一翻说道|拦住你说道|迈步挡在你身前|一把拦住你|哈哈一笑|俏眼一瞪|大喝一声|冷哼一声|大吼一声|长刀一摆|飞身挡住你的去路|扭身挡住|笑嘻嘻地挡住你的去路|吹着白胡子|用冷森森的眼光扫了你一眼|长剑电闪|对你道：善哉，后殿|说道: 你未经许可|大声喝道：他奶奶的，你要干嘛|挡住了你：我的小妞可不是给你们邪派弟子准备的！)","system","block_onnpc")
	...
	AddAlias("alias_lian","^#lian\\s(.*)$","",flag_base_enable+alias_flag.RegularExpression,"alias_lian")
	...
	addtri("on_partyhelp","^(> )*【(明教|天地会)】.{1,4}\\[(.*)\\]：helllua-help-(.*)-(.*)","masterquest","on_partyhelp")
	addtri("on_partyfind","^(> )*【(明教|天地会)】.{1,4}\\[(.*)\\]：helllua.find-(.*)-(.*)-(.*)-(.*)","masterquest","on_partyfind")
	...
	addtri("npc_killme","^(> )*(.{1,4})(一见到你|和你一碰面|对著你大喝：「可恶|喝道：「你|一眼瞥见你|和你仇人相见分外眼红)","system","npc_killme")
